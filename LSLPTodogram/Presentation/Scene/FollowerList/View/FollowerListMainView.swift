...
final class FollowerListMainView: BaseView {
...
//    }()
    lazy var tableView = {
        ...
        view.register(FollowerListCell.self, forCellReuseIdentifier: FollowerListCell.identifier)
